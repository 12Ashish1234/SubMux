  ...
  return (
    <div
      className={`rounded-xl border p-4 transition-all ${
        track.is_default
          ? 'bg-zinc-900/90 border-blue-500/50 shadow-md shadow-blue-500/5'
    ...
    >
        ...
        <div className="flex items-start space-x-3 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center space-x-2">
              <span className="font-medium text-zinc-200 text-xs truncate max-w-[280px]" title={track.filename}>
                {track.filename}
              </span>
              ...
              {track.is_default && (
                <span className="flex items-center space-x-1 text-[10px] font-semibold px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 border border-blue-500/30">
                  <Star className="w-2.5 h-2.5 fill-current" />
                  <span>Default Track</span>
                </span>
              )}
            </div>
            <p className="text-[11px] text-zinc-400 font-mono truncate mt-0.5" title={track.path}>
              {track.path}
            </p>
          </div>
        </div>
      ...
      {/* Track Config Inputs */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3.5 pt-3 border-t border-zinc-800/60">
        {/* Language selector */}
        <div>
          ...
          <div className="flex items-center space-x-2">
            <select
              ...
              className="bg-zinc-950 border border-zinc-700/80 rounded-lg px-2.5 py-1.5 text-xs text-zinc-200 focus:outline-none focus:border-blue-500 flex-1"
            >
            ...
            {isCustomLang && (
              <input
                ...
                className="w-24 bg-zinc-950 border border-zinc-700/80 rounded-lg px-2.5 py-1.5 text-xs font-mono text-zinc-200 focus:outline-none focus:border-blue-500"
              />
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-zinc-950 border border-zinc-700/80 rounded-lg px-2.5 py-1.5 text-xs text-zinc-200 focus:outline-none focus:border-blue-500"
          />
        </div>
      </div>
    </div>

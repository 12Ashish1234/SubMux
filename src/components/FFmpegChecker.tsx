...
export const FFmpegChecker: React.FC<FFmpegCheckerProps> = ({
  ...
  return (
    <div className="bg-rose-950/40 border border-rose-800/60 rounded-xl p-5 mb-6 text-zinc-200 shadow-lg backdrop-blur">
      <div className="flex items-start space-x-3.5">
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="bg-zinc-950/80 border border-zinc-800 rounded-lg p-2.5 flex items-center justify-between font-mono text-xs text-zinc-200">
